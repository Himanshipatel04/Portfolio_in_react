...
function SkillCard(props) {
  return (
    <div className=' rounded-tl-3xl rounded-br-3xl w-[300px] md:w-[400px] shadow flex  flex-col justify-center items-center pt-4 '>
      <p className='text-yellow-400 text-center font-semibold text-2xl'>{props.heading}</p>
