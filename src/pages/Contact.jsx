...
const Contact = () => {
  return (
    <div className="flex items-center justify-center h-screen w-screen md:w-full bg-black text-white flex-col pt-10 md:pt-28 gap-16 px-10 md:px-72">
      <p
        className="text-yellow-400 text-3xl text-center font-semibold tracking-widest"
        data-aos="fade-up"
        data-aos-delay="200"
      >
        CONTACT ME
      ...
      <button
        className="p-2 w-32 rounded-lg text-black font-semibold bg-yellow-400"
        data-aos="fade-up"
        data-aos-delay="200"
      >
        Send Message
